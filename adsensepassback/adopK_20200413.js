...
function adopRun837(){
    ...
    for(var j=0;j<$adpSet.length;j++ ){
        ...
        function listener102(e){
            ...
            console.log(strMsg);
            if(strMsg.googMsgType !== 'undefined'){

                if(strMsg.googMsgType == "pvt"){
                    console.log(strMsg.token);
                    psb = false
                }else if (strMsg.googMsgType == "adpnt"){
                    console.log(strMsg.googMsgType);
                    psb = false
                }else if (strMsg.googMsgType == "sth" && strMsg.msg_type == "resize-me"){
		    var pb_tag = "<img src='https://lh3.googleusercontent.com/ZtDtIxui1AGQm2ztWv4AhLwxnFHS9PRq_0aEQ_9G_0WIFe7kKhPPRPro6QKTU6nCOSU=w320-h100' width='320px' height='100px'/>";
		    var gq_id = strMsg.key_value[1].value;
  		    console.log(gq_id);
		    var y=document.getElementById(strIframeId);
/*
...
*/
		    //var ifr = $('iframe[data-google-query-id='+gq_id+']').parentNode;
		    //console.log(ifr);
		    //ifr.innerHTML = pb_tag;
                    //{"msg_type":"resize-me","key_value":[{"key":"r_nh","value":"0"},{"key":"qid","value":"CI_np5bfsugCFYwylgodAZ0FKg"}],"googMsgType":"sth"}
