...
function googleSetting01(gbannerid){
    googletag.cmd.push(function() {
        ...
        var adSlot1 = googletag.defineSlot(googleSlotCode,googleSlotSize, gbannerid);
        adSlot1.addService(googletag.pubads());
        googletag.pubads().set("page_url", compassPageUrl);
...
function compassAdTagInsert(gbannerid){
    ...
    if($obj){
        ...
        $script.src = "http://compass.adop.cc/assets/js/adop/adopJ.js?v=14";

        $ins = document.createElement("ins");
        $ins.setAttribute("class","adsbyadop");
        $ins.setAttribute("_adop_zon",compassZoneId);
        $ins.setAttribute("_adop_type","re");
        $ins.setAttribute("style","display;inline-block;width:"+compassAdwidth+"px;height:"+compassAdheight+"px;");
